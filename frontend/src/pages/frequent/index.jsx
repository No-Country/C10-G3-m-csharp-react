...
import Answerimg from "../../../public/images/Answerimg.png"
  ...
  return (
    <div className="Container">
      ...
      <div className="ContainerHeader">
        ...
        <div className="RutaLogin">
          <Link className="Cuadrado" href="/login">
            Login/
            <br />
            Registro
          </Link>
      ...
      <div className="ImagenAnswers">
        <div className="ImagenAnswer">
          <Image
            width={1550}
            height={0}
            src={Answerimg}
      ...
      <div>
        <Accordion className="AcordionGeneral">
          <AccordionSummary
            expandIcon={<ExpandMoreIcon />}
            aria-controls="panel1a-content"
            id="panel1a-header"
          >
            <Typography className="Text">¿Quiénes pueden utilizar esta aplicacion?</Typography>
          </AccordionSummary>
          <AccordionDetails>
        ...
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography className="Text" >¿Cómo puedo contribuir a la plataforma?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography className="Parrafo">
        ...
        <Accordion>
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography className="Text">¿Cómo se financia la plataforma?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography className="Parrafo">
